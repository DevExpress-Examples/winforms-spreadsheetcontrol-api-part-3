...
Namespace SpreadsheetControl_API_Part03
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.displayResultControl1 = New SpreadsheetControl_API_Part03.DisplayResultControl()
		...
		Public Sub New()
			...
			CurrentExampleLanguage = CodeExampleDemoUtils.DetectExampleLanguage("SpreadsheetControl_API_Part03")
		...
		Private Sub InitializeRichEditControl()
			Me.spreadsheetControl = Me.displayResultControl1.Speadsheet
		End Sub
